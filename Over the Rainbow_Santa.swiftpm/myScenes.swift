...
var myScenes: [MyScene] = [
    ...
    MyScene(imageName: "#2_3_1", subtitle: [("#2_3_1_s1", "#2_3_1_a1.mp3"), ("#2_3_1_s2", nil)],bgm: "#2_3_1_b.mp3",type: MyScene.SceneType.image),
    ...
    MyScene(imageName: "#2_6_1", subtitle: [("#2_6_1_s", "#2_6_1_a1.wav")],bgm: nil,type: MyScene.SceneType.gif),
    MyScene(imageName: "#2_6_2", subtitle: [("#2_6_2_s", "#2_6_2_a1.wav")],bgm: nil,type: MyScene.SceneType.gif),
    MyScene(imageName: "#2_6_3", subtitle: [("#2_6_3_s1", "#2_6_3_a1.mp3"), ("#2_6_3_s2", nil)],bgm: nil,type: MyScene.SceneType.gif),
    MyScene(imageName: "#3_1", subtitle: [("#3_1_s1", nil),("#3_1_s2", nil)],bgm: "#3_1_b.wav",type: MyScene.SceneType.gif),
    MyScene(imageName: "#3_2", subtitle: [("#3_2_s1", "#3_2_a1.mp3"), ("#3_2_s2", nil)],bgm: nil,type: MyScene.SceneType.gif),
    MyScene(imageName: "#3_3", subtitle: [("#3_3_s1", nil), ("#3_3_s2", nil)],bgm: "#3_3_b.wav",type: MyScene.SceneType.gif),
    MyScene(imageName: "#3_4", subtitle: [("#3_4_s", nil)],bgm: "#3_4_b.m4a",type: MyScene.SceneType.gif),
    MyScene(imageName: "#3_5", subtitle: [("#3_5_s", nil)],bgm: "#3_5_b.wav",type: MyScene.SceneType.gif),
    MyScene(imageName: "#4_1", subtitle: [("#4_1_s", nil)],bgm: "#4_1_1_b.wav",type: MyScene.SceneType.gif),
